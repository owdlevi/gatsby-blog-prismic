...
const DarkModeToggle = () => {
  ...
  console.log(isDark)
  return (
    <CSSTransition in={isDark} classNames="switch" onClick={() => toggleColorMode()} timeout={0}>
      <svg viewBox="0 0 170 70" fill="none" xmlns="http://www.w3.org/2000/svg" className="switch">
        <mask id="mask0" mask-type="alpha" maskUnits="userSpaceOnUse" x="0" y="0" width="170" height="70">
        ...
        <g mask="url(#mask0)">
          ...
          <path
            ...
            className="cloud1"
          />
          <rect x="154" y="28" width="1" height="1" transform="rotate(-45 154 28.4142)" fill="white" className="star1" />
          <rect x="135" y="24" width="1" height="1" transform="rotate(-45 135 24.4142)" fill="white" className="star2" />
          <rect x="143" y="12" width="3" height="3" transform="rotate(-45 143 12.4142)" fill="white" className="star3" />
          <rect x="125" y="6" width="1" height="1" transform="rotate(-45 125 6.41422)" fill="white" className="star4" />
          <rect x="114" y="20" width="2" height="2" transform="rotate(-45 114 20.4142)" fill="white" className="star5" />
          <rect x="15" y="16" width="2" height="2" transform="rotate(-45 15 16.4142)" fill="white" className="star6" />
          <rect x="29" y="22" width="1" height="1" transform="rotate(-45 29 22.4142)" fill="white" className="star7" />
          <rect x="37" y="12" width="2" height="2" transform="rotate(-45 79 22.4142)" fill="white" className="star8" />
          <rect x="68" y="12" width="1" height="1" transform="rotate(-45 68 12.4142)" fill="white" className="star9" />
          <rect x="94" y="10" width="3" height="3" transform="rotate(-45 94 10.4142)" fill="white" className="star10" />
          <rect x="79" y="22" width="2" height="2" transform="rotate(-45 79 22.4142)" fill="white" className="star11" />
          <rect x="52" y="19" width="1" height="1" transform="rotate(-45 52 19.4142)" fill="white" className="star12" />
          <path
            fillRule="evenodd"
            clipRule="evenodd"
        ...
        <defs>
          <linearGradient id="paint0_linear" x1="85" y1="0" x2="85" y2="70" gradientUnits="userSpaceOnUse">
